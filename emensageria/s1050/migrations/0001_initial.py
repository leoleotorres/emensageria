    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1050_evttabhortur', models.OneToOneField(related_name='s1050alteracao_s1050_evttabhortur', to='eventos.s1050evtTabHorTur')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1050_evttabhortur', models.OneToOneField(related_name='s1050exclusao_s1050_evttabhortur', to='eventos.s1050evtTabHorTur')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1050_evttabhortur', models.OneToOneField(related_name='s1050inclusao_s1050_evttabhortur', to='eventos.s1050evtTabHorTur')),
            ],
            options={
                'ordering': ['s1050_evttabhortur', 'codhorcontrat', 'inivalid', 'fimvalid', 'hrentr', 'hrsaida', 'durjornada', 'perhorflexivel'],

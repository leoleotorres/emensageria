    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1035_evttabcarreira', models.OneToOneField(related_name='s1035alteracao_s1035_evttabcarreira', to='eventos.s1035evtTabCarreira')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1035_evttabcarreira', models.OneToOneField(related_name='s1035exclusao_s1035_evttabcarreira', to='eventos.s1035evtTabCarreira')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1035_evttabcarreira', models.OneToOneField(related_name='s1035inclusao_s1035_evttabcarreira', to='eventos.s1035evtTabCarreira')),
            ],
            options={
                'ordering': ['s1035_evttabcarreira', 'codcarreira', 'inivalid', 'fimvalid', 'dsccarreira', 'leicarr', 'dtleicarr', 'sitcarr'],

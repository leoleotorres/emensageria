...
class s5011ideEstab(models.Model):
    s5011_evtcs = models.ForeignKey('eventos.s5011evtCS',
...
class s5011ideLotacao(models.Model):
    ...
    fpas = models.IntegerField(choices=CHOICES_S5011_FPAS)
    codtercs = models.CharField(choices=CHOICES_S5011_CODTERCS, max_length=4)
...
class s5011infoCPSeg(models.Model):
    s5011_evtcs = models.OneToOneField('eventos.s5011evtCS',
        related_name='%(class)s_s5011_evtcs')
    vrdesccp = models.DecimalField(max_digits=15, decimal_places=2, max_length=14)

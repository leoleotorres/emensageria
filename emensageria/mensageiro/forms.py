...
class form_transmissor_lote_ocorrencias(forms.ModelForm):

    def __init__(self,*args,**kwargs):
        slug = kwargs.pop('slug')
        super (form_transmissor_lote_ocorrencias,self ).__init__(*args,**kwargs)
        ...
        self.fields['transmissor_lote'].widget.attrs['required'] = True

    class Meta:
        model = TransmissorLoteOcorrencias
        exclude = [ 
            'excluido',
            'modificado_por',
            'modificado_em',
...
class form_transmissor_lote(forms.ModelForm):

    def __init__(self,*args,**kwargs):
        slug = kwargs.pop('slug')
        super (form_transmissor_lote,self ).__init__(*args,**kwargs)

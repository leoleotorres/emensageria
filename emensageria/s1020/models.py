...
CHOICES_S1020_ALTERACAO_CODTERC = (
    ('1', u'1 - Não Informado'),
)

CHOICES_S1020_ALTERACAO_CODTERCS = (
    ('1', u'1 - Não Informado'),
)

CHOICES_S1020_ALTERACAO_CODTERCSSUSP = (
    ('1', u'1 - Não Informado'),
)

CHOICES_S1020_ALTERACAO_FPAS = (
    (1, u'1 - Não Informado'),
)
...
CHOICES_S1020_INCLUSAO_CODTERC = (
    ('1', u'1 - Não Informado'),
)

CHOICES_S1020_INCLUSAO_CODTERCS = (
    ('1', u'1 - Não Informado'),
)

CHOICES_S1020_INCLUSAO_CODTERCSSUSP = (
    ('1', u'1 - Não Informado'),
)

CHOICES_S1020_INCLUSAO_FPAS = (
    (1, u'1 - Não Informado'),
)
...
class s1020alteracao(models.Model):
    s1020_evttablotacao = models.OneToOneField('eventos.s1020evtTabLotacao',
    ...
    fpas = models.IntegerField(choices=CHOICES_S1020_ALTERACAO_FPAS)
    codtercs = models.CharField(choices=CHOICES_S1020_ALTERACAO_CODTERCS, max_length=4)
    codtercssusp = models.CharField(choices=CHOICES_S1020_ALTERACAO_CODTERCSSUSP, max_length=4, blank=True, null=True)
...
class s1020alteracaoprocJudTerceiro(models.Model):
    ...
    codterc = models.CharField(choices=CHOICES_S1020_ALTERACAO_CODTERC, max_length=4)
...
class s1020inclusao(models.Model):
    ...
    nrinsc = models.CharField(max_length=15, blank=True, null=True)
    fpas = models.IntegerField(choices=CHOICES_S1020_INCLUSAO_FPAS)
    codtercs = models.CharField(choices=CHOICES_S1020_INCLUSAO_CODTERCS, max_length=4)
    codtercssusp = models.CharField(choices=CHOICES_S1020_INCLUSAO_CODTERCSSUSP, max_length=4, blank=True, null=True)
    criado_em = models.DateTimeField(blank=True)
    criado_por = models.ForeignKey('controle_de_acesso.Usuarios',
        related_name='%(class)s_criado_por', blank=True, null=True)
    modificado_em = models.DateTimeField(blank=True, null=True)
...
class s1020inclusaoprocJudTerceiro(models.Model):
    ...
    codterc = models.CharField(choices=CHOICES_S1020_INCLUSAO_CODTERC, max_length=4)
    nrprocjud = models.CharField(max_length=20)
    codsusp = models.IntegerField()
    criado_em = models.DateTimeField(blank=True)
    criado_por = models.ForeignKey('controle_de_acesso.Usuarios',

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codtercssusp', models.CharField(blank=True, max_length=4, null=True, choices=[(b'1', '1 - N\xe3o Informado')])),
                ...
                ('s1020_evttablotacao', models.OneToOneField(related_name='s1020alteracao_s1020_evttablotacao', to='eventos.s1020evtTabLotacao')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('codterc', models.CharField(max_length=4, choices=[(b'1', '1 - N\xe3o Informado')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1020_evttablotacao', models.OneToOneField(related_name='s1020exclusao_s1020_evttablotacao', to='eventos.s1020evtTabLotacao')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1020_evttablotacao', models.OneToOneField(related_name='s1020inclusao_s1020_evttablotacao', to='eventos.s1020evtTabLotacao')),
            ],
            options={
                'ordering': ['s1020_evttablotacao', 'codlotacao', 'inivalid', 'fimvalid', 'tplotacao', 'tpinsc', 'nrinsc', 'fpas', 'codtercs', 'codtercssusp'],

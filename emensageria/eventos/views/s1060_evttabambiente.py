...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1060_evttabambiente_ocorrencias_form = None
        ...
        if s1060_evttabambiente_id:
            ...
            s1060_evttabambiente_ocorrencias_form = form_s1060_evttabambiente_ocorrencias(initial={ 'evento': s1060_evttabambiente }, slug=db_slug)
            s1060_evttabambiente_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1060_evttabambiente_ocorrencias_lista = s1060evtTabAmbienteOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1060_evttabambiente.id).all()

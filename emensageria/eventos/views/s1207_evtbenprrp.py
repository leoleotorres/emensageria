...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1207_evtbenprrp_ocorrencias_form = None
        ...
        if s1207_evtbenprrp_id:
            ...
            s1207_evtbenprrp_ocorrencias_form = form_s1207_evtbenprrp_ocorrencias(initial={ 'evento': s1207_evtbenprrp }, slug=db_slug)
            s1207_evtbenprrp_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1207_evtbenprrp_ocorrencias_lista = s1207evtBenPrRPOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1207_evtbenprrp.id).all()

...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1040_evttabfuncao_ocorrencias_form = None
        ...
        if s1040_evttabfuncao_id:
            ...
            s1040_evttabfuncao_ocorrencias_form = form_s1040_evttabfuncao_ocorrencias(initial={ 'evento': s1040_evttabfuncao }, slug=db_slug)
            s1040_evttabfuncao_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1040_evttabfuncao_ocorrencias_lista = s1040evtTabFuncaoOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1040_evttabfuncao.id).all()

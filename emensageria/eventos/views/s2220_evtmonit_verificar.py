...
import base64
from emensageria.s2220.models import *
from emensageria.s2220.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s2220evtMonitOcorrencias.objects.using( db_slug ).filter(evento_id=s2220_evtmonit_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's2220_evtmonit_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

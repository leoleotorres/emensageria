...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s1270evtContratAvNPOcorrencias.objects.using( db_slug ).filter(evento_id=s1270_evtcontratavnp_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's1270_evtcontratavnp_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

...
from emensageria.s1299.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s1299evtFechaEvPerOcorrencias.objects.using( db_slug ).filter(evento_id=s1299_evtfechaevper_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's1299_evtfechaevper_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

...
import base64
from emensageria.s1298.models import *
from emensageria.s1298.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s1298evtReabreEvPerOcorrencias.objects.using( db_slug ).filter(evento_id=s1298_evtreabreevper_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's1298_evtreabreevper_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

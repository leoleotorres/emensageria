...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1280_evtinfocomplper_ocorrencias_form = None
        ...
        if s1280_evtinfocomplper_id:
            ...
            s1280_evtinfocomplper_ocorrencias_form = form_s1280_evtinfocomplper_ocorrencias(initial={ 'evento': s1280_evtinfocomplper }, slug=db_slug)
            s1280_evtinfocomplper_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1280_evtinfocomplper_ocorrencias_lista = s1280evtInfoComplPerOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1280_evtinfocomplper.id).all()

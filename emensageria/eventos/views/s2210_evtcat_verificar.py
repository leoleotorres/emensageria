...
import base64
from emensageria.s2210.models import *
from emensageria.s2210.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s2210evtCATOcorrencias.objects.using( db_slug ).filter(evento_id=s2210_evtcat_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's2210_evtcat_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

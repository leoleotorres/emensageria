...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s2241_evtinsapo_ocorrencias_form = None
        ...
        if s2241_evtinsapo_id:
            ...
            s2241_evtinsapo_ocorrencias_form = form_s2241_evtinsapo_ocorrencias(initial={ 'evento': s2241_evtinsapo }, slug=db_slug)
            s2241_evtinsapo_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s2241_evtinsapo_ocorrencias_lista = s2241evtInsApoOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s2241_evtinsapo.id).all()

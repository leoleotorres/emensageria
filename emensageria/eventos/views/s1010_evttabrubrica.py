...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1010_evttabrubrica_ocorrencias_form = None
        ...
        if s1010_evttabrubrica_id:
            ...
            s1010_evttabrubrica_ocorrencias_form = form_s1010_evttabrubrica_ocorrencias(initial={ 'evento': s1010_evttabrubrica }, slug=db_slug)
            s1010_evttabrubrica_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1010_evttabrubrica_ocorrencias_lista = s1010evtTabRubricaOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1010_evttabrubrica.id).all()

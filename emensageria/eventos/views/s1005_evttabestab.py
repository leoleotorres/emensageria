...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1005_evttabestab_ocorrencias_form = None
        ...
        if s1005_evttabestab_id:
            ...
            s1005_evttabestab_ocorrencias_form = form_s1005_evttabestab_ocorrencias(initial={ 'evento': s1005_evttabestab }, slug=db_slug)
            s1005_evttabestab_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1005_evttabestab_ocorrencias_lista = s1005evtTabEstabOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1005_evttabestab.id).all()

...
import base64
from emensageria.s2190.models import *
from emensageria.s2190.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s2190evtAdmPrelimOcorrencias.objects.using( db_slug ).filter(evento_id=s2190_evtadmprelim_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's2190_evtadmprelim_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

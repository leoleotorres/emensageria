...
import base64
from emensageria.s1300.models import *
from emensageria.s1300.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s1300evtContrSindPatrOcorrencias.objects.using( db_slug ).filter(evento_id=s1300_evtcontrsindpatr_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's1300_evtcontrsindpatr_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

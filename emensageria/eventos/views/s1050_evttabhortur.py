...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1050_evttabhortur_ocorrencias_form = None
        ...
        if s1050_evttabhortur_id:
            ...
            s1050_evttabhortur_ocorrencias_form = form_s1050_evttabhortur_ocorrencias(initial={ 'evento': s1050_evttabhortur }, slug=db_slug)
            s1050_evttabhortur_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1050_evttabhortur_ocorrencias_lista = s1050evtTabHorTurOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1050_evttabhortur.id).all()

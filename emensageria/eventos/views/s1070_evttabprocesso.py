...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1070_evttabprocesso_ocorrencias_form = None
        ...
        if s1070_evttabprocesso_id:
            ...
            s1070_evttabprocesso_ocorrencias_form = form_s1070_evttabprocesso_ocorrencias(initial={ 'evento': s1070_evttabprocesso }, slug=db_slug)
            s1070_evttabprocesso_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1070_evttabprocesso_ocorrencias_lista = s1070evtTabProcessoOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1070_evttabprocesso.id).all()

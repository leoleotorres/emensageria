...
import base64
from emensageria.s1295.models import *
from emensageria.s1295.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s1295evtTotContingOcorrencias.objects.using( db_slug ).filter(evento_id=s1295_evttotconting_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's1295_evttotconting_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

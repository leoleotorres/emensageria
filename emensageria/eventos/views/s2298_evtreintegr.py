...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s2298_evtreintegr_ocorrencias_form = None
        s2298_evtreintegr_ocorrencias_lista = None
        if s2298_evtreintegr_id:
            s2298_evtreintegr = get_object_or_404(s2298evtReintegr.objects.using( db_slug ), excluido = False, id = s2298_evtreintegr_id)
       
            s2298_evtreintegr_ocorrencias_form = form_s2298_evtreintegr_ocorrencias(initial={ 'evento': s2298_evtreintegr }, slug=db_slug)
            s2298_evtreintegr_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s2298_evtreintegr_ocorrencias_lista = s2298evtReintegrOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s2298_evtreintegr.id).all()
        else:

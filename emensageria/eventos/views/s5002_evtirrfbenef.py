...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s5002_evtirrfbenef_ocorrencias_form = None
        ...
        if s5002_evtirrfbenef_id:
            ...
            s5002_evtirrfbenef_ocorrencias_form = form_s5002_evtirrfbenef_ocorrencias(initial={ 'evento': s5002_evtirrfbenef }, slug=db_slug)
            s5002_evtirrfbenef_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s5002_evtirrfbenef_ocorrencias_lista = s5002evtIrrfBenefOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s5002_evtirrfbenef.id).all()

...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s1035evtTabCarreiraOcorrencias.objects.using( db_slug ).filter(evento_id=s1035_evttabcarreira_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's1035_evttabcarreira_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

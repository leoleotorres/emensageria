...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1035_evttabcarreira_ocorrencias_form = None
        ...
        if s1035_evttabcarreira_id:
            ...
            s1035_evttabcarreira_ocorrencias_form = form_s1035_evttabcarreira_ocorrencias(initial={ 'evento': s1035_evttabcarreira }, slug=db_slug)
            s1035_evttabcarreira_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1035_evttabcarreira_ocorrencias_lista = s1035evtTabCarreiraOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1035_evttabcarreira.id).all()

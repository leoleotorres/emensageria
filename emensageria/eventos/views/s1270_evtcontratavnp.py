...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1270_evtcontratavnp_ocorrencias_form = None
        ...
        if s1270_evtcontratavnp_id:
            ...
            s1270_evtcontratavnp_ocorrencias_form = form_s1270_evtcontratavnp_ocorrencias(initial={ 'evento': s1270_evtcontratavnp }, slug=db_slug)
            s1270_evtcontratavnp_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1270_evtcontratavnp_ocorrencias_lista = s1270evtContratAvNPOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1270_evtcontratavnp.id).all()

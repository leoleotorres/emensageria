...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1030_evttabcargo_ocorrencias_form = None
        ...
        if s1030_evttabcargo_id:
            ...
            s1030_evttabcargo_ocorrencias_form = form_s1030_evttabcargo_ocorrencias(initial={ 'evento': s1030_evttabcargo }, slug=db_slug)
            s1030_evttabcargo_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1030_evttabcargo_ocorrencias_lista = s1030evtTabCargoOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1030_evttabcargo.id).all()

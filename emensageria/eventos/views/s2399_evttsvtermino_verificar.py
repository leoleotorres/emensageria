...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s2399evtTSVTerminoOcorrencias.objects.using( db_slug ).filter(evento_id=s2399_evttsvtermino_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's2399_evttsvtermino_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

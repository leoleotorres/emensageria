...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1300_evtcontrsindpatr_ocorrencias_form = None
        ...
        if s1300_evtcontrsindpatr_id:
            ...
            s1300_evtcontrsindpatr_ocorrencias_form = form_s1300_evtcontrsindpatr_ocorrencias(initial={ 'evento': s1300_evtcontrsindpatr }, slug=db_slug)
            s1300_evtcontrsindpatr_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1300_evtcontrsindpatr_ocorrencias_lista = s1300evtContrSindPatrOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1300_evtcontrsindpatr.id).all()

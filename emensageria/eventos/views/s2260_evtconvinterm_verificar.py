...
import base64
from emensageria.s2260.models import *
from emensageria.s2260.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s2260evtConvIntermOcorrencias.objects.using( db_slug ).filter(evento_id=s2260_evtconvinterm_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's2260_evtconvinterm_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

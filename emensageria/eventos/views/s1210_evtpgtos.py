...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1210_evtpgtos_ocorrencias_form = None
        ...
        if s1210_evtpgtos_id:
            ...
            s1210_evtpgtos_ocorrencias_form = form_s1210_evtpgtos_ocorrencias(initial={ 'evento': s1210_evtpgtos }, slug=db_slug)
            s1210_evtpgtos_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1210_evtpgtos_ocorrencias_lista = s1210evtPgtosOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1210_evtpgtos.id).all()

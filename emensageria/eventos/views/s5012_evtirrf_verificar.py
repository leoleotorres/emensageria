...
import base64
from emensageria.s5012.models import *
from emensageria.s5012.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s5012evtIrrfOcorrencias.objects.using( db_slug ).filter(evento_id=s5012_evtirrf_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's5012_evtirrf_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

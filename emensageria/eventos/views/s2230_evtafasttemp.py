...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s2230_evtafasttemp_ocorrencias_form = None
        ...
        if s2230_evtafasttemp_id:
            ...
            s2230_evtafasttemp_ocorrencias_form = form_s2230_evtafasttemp_ocorrencias(initial={ 'evento': s2230_evtafasttemp }, slug=db_slug)
            s2230_evtafasttemp_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s2230_evtafasttemp_ocorrencias_lista = s2230evtAfastTempOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s2230_evtafasttemp.id).all()

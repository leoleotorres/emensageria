...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1260_evtcomprod_ocorrencias_form = None
        ...
        if s1260_evtcomprod_id:
            ...
            s1260_evtcomprod_ocorrencias_form = form_s1260_evtcomprod_ocorrencias(initial={ 'evento': s1260_evtcomprod }, slug=db_slug)
            s1260_evtcomprod_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1260_evtcomprod_ocorrencias_lista = s1260evtComProdOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1260_evtcomprod.id).all()

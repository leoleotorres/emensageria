...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s1250evtAqProdOcorrencias.objects.using( db_slug ).filter(evento_id=s1250_evtaqprod_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's1250_evtaqprod_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

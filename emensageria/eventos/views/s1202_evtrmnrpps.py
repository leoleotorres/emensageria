...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1202_evtrmnrpps_ocorrencias_form = None
        ...
        if s1202_evtrmnrpps_id:
            ...
            s1202_evtrmnrpps_ocorrencias_form = form_s1202_evtrmnrpps_ocorrencias(initial={ 'evento': s1202_evtrmnrpps }, slug=db_slug)
            s1202_evtrmnrpps_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1202_evtrmnrpps_ocorrencias_lista = s1202evtRmnRPPSOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1202_evtrmnrpps.id).all()

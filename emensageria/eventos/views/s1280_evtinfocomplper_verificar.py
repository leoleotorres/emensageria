...
import base64
from emensageria.s1280.models import *
from emensageria.s1280.forms import *
...
def verificar(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        ocorrencias_lista = s1280evtInfoComplPerOcorrencias.objects.using( db_slug ).filter(evento_id=s1280_evtinfocomplper_id, excluido = False).all()
...
def recibo(request, hash, slug=0):
    ...
    if permissao.permite_listar:
        ...
        return render(request, 's1280_evtinfocomplper_recibo.html', context)
    else:
        context = {
            'usuario': usuario, 
            'conta': conta, 

...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1020_evttablotacao_ocorrencias_form = None
        ...
        if s1020_evttablotacao_id:
            ...
            s1020_evttablotacao_ocorrencias_form = form_s1020_evttablotacao_ocorrencias(initial={ 'evento': s1020_evttablotacao }, slug=db_slug)
            s1020_evttablotacao_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1020_evttablotacao_ocorrencias_lista = s1020evtTabLotacaoOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1020_evttablotacao.id).all()

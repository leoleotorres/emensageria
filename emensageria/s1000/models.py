...
CHOICES_S1000_ALTERACAO_NATJURID = (
    ('101', u'101-5 - Órgão Público do Poder Executivo Federal'),
    ('102', u'102-3 - Órgão Público do Poder Executivo Estadual ou do Distrito Federal'),
    ('103', u'103-1 - Órgão Público do Poder Executivo Municipal'),
    ('104', u'104-0 - Órgão Público do Poder Legislativo Federal'),
    ('105', u'105-8 - Órgão Público do Poder Legislativo Estadual ou do Distrito Federal'),
    ('106', u'106-6 - Órgão Público do Poder Legislativo Municipal'),
    ('107', u'107-4 - Órgão Público do Poder Judiciário Federal'),
    ('108', u'108-2 - Órgão Público do Poder Judiciário Estadual'),
    ('110', u'110-4 - Autarquia Federal'),
    ('111', u'111-2 - Autarquia Estadual ou do Distrito Federal'),
    ('112', u'112-0 - Autarquia Municipal'),
    ('113', u'113-9 - Fundação Pública de Direito Público Federal'),
    ('114', u'114-7 - Fundação Pública de Direito Público Estadual ou do Distrito Federal'),
    ('115', u'115-5 - Fundação Pública de Direito Público Municipal'),
    ('116', u'116-3 - Órgão Público Autônomo Federal'),
    ('117', u'117-1 - Órgão Público Autônomo Estadual ou do Distrito Federal'),
    ('118', u'118-0 - Órgão Público Autônomo Municipal'),
    ('119', u'119-8 - Comissão Polinacional'),
    ('120', u'120-1 - Fundo Público'),
    ('121', u'121-0 - Consórcio Público de Direito Público (Associação Pública)'),
    ('122', u'122-8 - Consórcio Público de Direito Privado'),
    ('123', u'123-6 - Estado ou Distrito Federal'),
    ('124', u'124-4 - Município'),
    ('125', u'125-2 - Fundação Pública de Direito Privado Federal'),
    ('126', u'126-0 - Fundação Pública de Direito Privado Estadual ou do Distrito Federal'),
    ('127', u'127-9 - Fundação Pública de Direito Privado Municipal'),
    ('201', u'201-1 - Empresa Pública'),
    ('203', u'203-8 - Sociedade de Economia Mista'),
    ('204', u'204-6 - Sociedade Anônima Aberta'),
    ('205', u'205-4 - Sociedade Anônima Fechada'),
    ('206', u'206-2 - Sociedade Empresária Limitada'),
    ('207', u'207-0 - Sociedade Empresária em Nome Coletivo'),
    ('208', u'208-9 - Sociedade Empresária em Comandita Simples'),
    ('209', u'209-7 - Sociedade Empresária em Comandita por Ações'),
    ('212', u'212-7 - Sociedade em Conta de Participação'),
    ('213', u'213-5 - Empresário (Individual)'),
    ('214', u'214-3 - Cooperativa'),
    ('215', u'215-1 - Consórcio de Sociedades'),
    ('216', u'216-0 - Grupo de Sociedades'),
    ('217', u'217-8 - Estabelecimento, no Brasil, de Sociedade Estrangeira'),
    ('219', u'219-4 - Estabelecimento, no Brasil, de Empresa Binacional Argentino-Brasileira'),
    ('221', u'221-6 - Empresa Domiciliada no Exterior'),
    ('222', u'222-4 - Clube/Fundo de Investimento'),
    ('223', u'223-2 - Sociedade Simples Pura'),
    ('224', u'224-0 - Sociedade Simples Limitada'),
    ('225', u'225-9 - Sociedade Simples em Nome Coletivo'),
    ('226', u'226-7 - Sociedade Simples em Comandita Simples'),
    ('227', u'227-5 - Empresa Binacional'),
    ('228', u'228-3 - Consórcio de Empregadores'),
    ('229', u'229-1 - Consórcio Simples'),
    ('230', u'230-5 - Empresa Individual de Responsabilidade Limitada (de Natureza Empresária)'),
    ('231', u'231-3 - Empresa Individual de Responsabilidade Limitada (de Natureza Simples)'),
    ('232', u'232-1 - Sociedade Unipessoal de Advogados'),
    ('233', u'233-0 - Cooperativas de Consumo'),
    ('303', u'303-4 - Serviço Notarial e Registral (Cartório)'),
    ('306', u'306-9 - Fundação Privada'),
    ('307', u'307-7 - Serviço Social Autônomo'),
    ('308', u'308-5 - Condomínio Edilício'),
    ('310', u'310-7 - Comissão de Conciliação Prévia'),
    ('311', u'311-5 - Entidade de Mediação e Arbitragem'),
    ('313', u'313-1 - Entidade Sindical'),
    ('320', u'320-4 - Estabelecimento, no Brasil, de Fundação ou Associação Estrangeiras'),
    ('321', u'321-2 - Fundação ou Associação Domiciliada no Exterior'),
    ('322', u'322-0 - Organização Religiosa'),
    ('323', u'323-9 - Comunidade Indígena'),
    ('324', u'324-7 - Fundo Privado'),
    ('325', u'325-5 - Órgão de Direção Nacional de Partido Político'),
    ('326', u'326-3 - Órgão de Direção Regional de Partido Político'),
    ('327', u'327-1 - Órgão de Direção Local de Partido Político'),
    ('328', u'328-0 - Comitê Financeiro de Partido Político'),
    ('329', u'329-8 - Frente Plebiscitária ou Referendária'),
    ('330', u'330-6 - Organização Social (OS)'),
    ('331', u'331-0 - Demais Condomínios'),
    ('399', u'399-9 - Associação Privada'),
    ('401', u'401-4 - Empresa Individual Imobiliária'),
    ('402', u'402-2 - Segurado Especial'),
    ('408', u'408-1 - Contribuinte individual'),
    ('409', u'409-0 - Candidato a Cargo Político Eletivo'),
    ('411', u'411-1 - Leiloeiro'),
    ('412', u'412-4 - Produtor Rural (Pessoa Física)'),
    ('501', u'501-0 - Organização Internacional'),
    ('502', u'502-9 - Representação Diplomática Estrangeira'),
    ('503', u'503-7 - Outras Instituições Extraterritoriais'),
)
...
class s1000alteracao(models.Model):
    s1000_evtinfoempregador = models.OneToOneField('eventos.s1000evtInfoEmpregador',

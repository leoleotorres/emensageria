    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1080_evttaboperport', models.OneToOneField(related_name='s1080alteracao_s1080_evttaboperport', to='eventos.s1080evtTabOperPort')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1080_evttaboperport', models.OneToOneField(related_name='s1080exclusao_s1080_evttaboperport', to='eventos.s1080evtTabOperPort')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1080_evttaboperport', models.OneToOneField(related_name='s1080inclusao_s1080_evttaboperport', to='eventos.s1080evtTabOperPort')),
            ],
            options={
                'ordering': ['s1080_evttaboperport', 'cnpjopportuario', 'inivalid', 'fimvalid', 'aliqrat', 'fap', 'aliqratajust'],

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s3000_evtexclusao', models.OneToOneField(related_name='s3000idefolhapagto_s3000_evtexclusao', to='eventos.s3000evtExclusao')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s3000_evtexclusao', models.OneToOneField(related_name='s3000idetrabalhador_s3000_evtexclusao', to='eventos.s3000evtExclusao')),
            ],
            options={

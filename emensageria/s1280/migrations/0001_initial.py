    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1280_evtinfocomplper', models.OneToOneField(related_name='s1280infoativconcom_s1280_evtinfocomplper', to='eventos.s1280evtInfoComplPer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1280_evtinfocomplper', models.OneToOneField(related_name='s1280infosubstpatr_s1280_evtinfocomplper', to='eventos.s1280evtInfoComplPer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s1280_evtinfocomplper', models.ForeignKey(related_name='s1280infosubstpatropport_s1280_evtinfocomplper', to='eventos.s1280evtInfoComplPer')),
            ],
            options={

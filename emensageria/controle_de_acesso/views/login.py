...
import urllib
from emensageria.settings import VERSAO_EMENSAGERIA
    ...
    if request.POST:
        ...
        if nome_usuario and usuario:
            ...
            if senha_db == hash_senha and senha != '':
                ...
                return redirect('transmissor_lote',  hash='eyJyZXR1cm5fcGFnZSI6ICJ0cmFuc21pc3Nvcl9sb3RlIiwgInJldHVybl9oYXNoIjogImUzMD0iLCAiaWQiOiAiMCIsICJwcmludCI6ICIwIn0=')
            else:
...
def enviar_email_senha_recuperar(nome, email_usuario, senha, conta):
    ...
    mensagem_html = u"""
<p>Prezado %s,<br>
Acesse o sistema www.emensageria.adm.br pelo link
<a href="http://www.emensageria.adm.br/%s/">www.emensageria.adm.br/%s/</a><br>
Nova senha é <strong>%s</strong><br>
E-mail gerado automaticamente pelo sistema www.emensageria.com</p>

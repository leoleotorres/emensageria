...
def enviar_email_senha_recuperar(nome, email_usuario, senha, conta):
    ...
    if conta.slug:
        mensagem_html = u"""
            <p>Prezado %s,<br>
            Acesse o sistema www.emensageria.adm.br/emensageria/ pelo link
            <a href="http://www.emensageria.adm.br/emensageria//%s/">www.emensageria.adm.br/emensageria//%s/</a><br>
            Nova senha é <strong>%s</strong><br>
            E-mail gerado automaticamente pelo sistema www.emensageria.adm.br/emensageria/</p>
        """ % (nome, conta.slug, conta.slug, senha)
    else:
        mensagem_html = u"""
            <p>Prezado %s,<br>
            Acesse o sistema www.emensageria.adm.br/emensageria/ pelo link
            <a href="http://www.emensageria.adm.br/emensageria//">www.emensageria.adm.br/emensageria//</a><br>
            Nova senha é <strong>%s</strong><br>
            E-mail gerado automaticamente pelo sistema www.emensageria.adm.br/emensageria/</p>
        """ % (nome, senha)

    send_mail(
        u'Recuperação de senha | www.emensageria.adm.br/emensageria/',
        strip_tags(mensagem_html),
        'recuperacao-de-senha@emensageria.adm.br/emensageria/',
        [ email_usuario, ],
        fail_silently=False,
...
def recuperar_senha(request):
    ...
    if request.method == 'POST':
        ...
        if dados_usuario:
            ...
            enviar_email_senha_recuperar(dados_usuario.nome, email, nova_senha, conta)

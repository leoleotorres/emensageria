...
CHOICES_S5002_TPCR = (
    (473, u'0473-01 - Renda e Proventos de Qualquer Natureza'),
    (561, u'0561-12 - IRRF - Empregado/Trabalhador Rural - Segurado Especial 13° salário'),
    (561, u'0561-11 - IRRF - Empregado/Trabalhador Rural - Segurado Especial'),
    (561, u'0561-10 - IRRF - Empregado doméstico - 13º salário'),
    (561, u'0561-09 - IRRF - Empregado Doméstico - 13º Sal Rescisão'),
    (561, u'0561-08 - IRRF - Empregado Doméstico'),
    (561, u'0561-07 - IRRF - Rendimento do Trabalho Assalariado no País/Ausente no Exterior a Serviço do País'),
    (561, u'0561-13 - IRRF - Empregado/Trabalhador Rural - Segurado Especial 13° salário rescisório'),
    (588, u'0588-06 - IRRF - Rendimento do trabalho sem vínculo empregatício'),
    (610, u'0610-01 - IRRF - Rendimentos relativos a prestação de serviços de transporte rodoviário internacional de carga, pagos a transportador autônomo PF residente no Paraguai'),
    (3280, u'3280-06 - IRRF - Serviços Prestados por associados de cooperativas de trabalho'),
    (3533, u'3533 - Proventos de Aposentadoria, Reserva, Reforma ou Pensão Pagos por Previdência Pública'),
    (3562, u'3562-01 - IRRF - Participação dos trabalhadores em Lucros ou Resultados (PLR)'),
)
...
class s5002infoDep(models.Model):
    s5002_evtirrfbenef = models.OneToOneField('eventos.s5002evtIrrfBenef',
...
class s5002infoIrrf(models.Model):
    s5002_evtirrfbenef = models.ForeignKey('eventos.s5002evtIrrfBenef',
        related_name='%(class)s_s5002_evtirrfbenef')
